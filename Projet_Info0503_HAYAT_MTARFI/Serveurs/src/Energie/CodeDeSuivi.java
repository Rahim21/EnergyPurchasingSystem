...
public class CodeDeSuivi /* implements Comparable<CodeDeSuivi> */ {
    ...
    public static String encoder(Energie e) {
        ...
        code += (int) Math.log10(e.getPrix()) + 1; // chiffre du prix avant la virgule
    ...
    public static Energie decoder(String code) {
        ...
        return new Energie(idProprietaire, type, origine, quantite, prix); // récupérer le nom du producteur ...
    }
}
